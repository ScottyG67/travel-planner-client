    ...
    render() {
        return (
            <div>
                ...
                {this.props.selectedFlight ? <DetailCard flight={this.props.selectedFlight} changeFlight={this.props.changeSelectedFlight} btnTxt={"Book Now!"} trips={this.state.trips} changeBooking={this.saveFlight} /> : null }
            </div>
        )
    }
}